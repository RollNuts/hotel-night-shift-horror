...
can validate motion and body-pressure readability without rendering a full trailer.
"""
...
def sanitize_sequence_metadata(sequence: unreal.LevelSequence) -> None:
    ...
    try_set_property(
        metadata,
        "notes",
        "Generated by Automation/Unreal/create_return_route_trailer_beat_assets.py for internal ReturnRoute trailer proof with body-pressure camera keys.",
    )
