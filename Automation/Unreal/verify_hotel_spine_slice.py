...
REQUIRED_ACTOR_TAGS = {
    ...
    "RETURN_Route_BackKnockDirectionStripe": ["Hotel.Capture.Readability", "Hotel.Capture.ReturnRouteAnomaly", "Hotel.Feedback.ReturnRouteBackKnock"],
    "RETURN_Route_BackKnockDirectionStripe_Return": ["Hotel.Capture.Readability", "Hotel.Capture.ReturnRouteAnomaly", "Hotel.Feedback.ReturnRouteBackKnock"],
